# NMA_Acinetobacter
Data and code for Bayesian network meta-analysis of antibiotics in multidrug-resistant Acinetobacter baumannii infections
...
1. Clone repo:
```bash
git clone https://github.com/<Owner>/NMA_Acinetobacter.git
